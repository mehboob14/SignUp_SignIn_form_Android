...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_CONTACTS + "("
                + KEY_EMAIL + " INTEGER PRIMARY KEY," + KEY_USERNAME + " TEXT,"
                + KEY_PASSWORD + " TEXT" + ")";
    ...
    UserInfo getuser(String email) {
        ...
        Cursor cursor = db.query(TABLE_CONTACTS, new String[] { KEY_EMAIL,
    ...
    public int updateUser(UserInfo contact) {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        return db.update(TABLE_CONTACTS, values, KEY_EMAIL + " = ?",
                new String[] { String.valueOf(contact.getPassword()) });
    }
  /*  public void deleteBlog( contact) {
        SQLiteDatabase db = this.getWritableDatabase();
